...
begin
//Ввод_данных_модели
  Путь_запуска_:= Резиденцмя_Гиперсистемы +'\Проекты\Ввод модели\Debug\Win32\Ввод_модели.EXE';
...
begin
//Синтез_модели
  Путь_запуска_:= Резиденцмя_Гиперсистемы +'\Проекты\Синтез модели\Debug\Win32\Синтез_модели.EXE';
  Путь_запуска:= PWideChar(Путь_запуска_);
  ShellExecute(Handle,nil, Путь_запуска,nil,nil,SW_Restore);
end;
